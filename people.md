...
<div class="people-grid">
  ...
  <article class="person-card"><img src="{{ '/files/Default_profile.jpg' | relative_url }}" alt="Default profile image for Yubo Wang" loading="lazy"><div><h3>Yubo Wang</h3><p>Master's student (2025.09-present)</p></div></article>
...
<div class="people-grid">
  ...
  <article class="person-card"><img src="{{ '/files/Xiang_profile.jpg' | relative_url }}" alt="Zhiqiang Xiang" loading="lazy"><div><h3>Zhiqiang Xiang</h3><p>Master's graduate (2021.09-2024.06)<br>Public servant</p><p><a href="{{ '/files/papers/xiang-2026-landscape-diversity-ndvi-stability.pdf' | relative_url }}">2026 publication (PDF)</a></p></div></article>
  <article class="person-card"><img src="{{ '/files/Yang_profile.jpg' | relative_url }}" alt="Xianglin Yang" loading="lazy"><div><h3>Xianglin Yang</h3><p>Master's graduate (2021.09-2024.06)<br>Ph.D. student at Lanzhou University (LZU)</p><p><a href="{{ '/files/papers/yang-2024-invasive-plants-phylogenetic-structure.pdf' | relative_url }}">2024 publication (PDF)</a></p></div></article>
  <article class="person-card"><img src="{{ '/files/Default_profile.jpg' | relative_url }}" alt="Default profile image for Huan Dong" loading="lazy"><div><h3>Huan Dong</h3><p>Master's graduate (2019.09-2022.06)<br>Public servant</p></div></article>
  ...
  <article class="person-card"><img src="{{ '/files/Default_profile.jpg' | relative_url }}" alt="Xuechao Fu" loading="lazy"><div><h3>Xuechao Fu</h3><p>Bachelor's graduate (2020.09-2024.06)</p></div></article>
  <article class="person-card"><img src="{{ '/files/MengluanJiang_profile.jpg' | relative_url }}" alt="Mengluan Jiang" loading="lazy"><div><h3>Mengluan Jiang</h3><p>Bachelor's graduate (2019.09-2023.06)<br>Ph.D. student, Peking University</p></div></article>
  <article class="person-card"><img src="{{ '/files/Default_profile.jpg' | relative_url }}" alt="Wenjie Song" loading="lazy"><div><h3>Wenjie Song</h3><p>Bachelor's graduate (2019.09-2023.06)</p></div></article>
  <article class="person-card"><img src="{{ '/files/Default_profile.jpg' | relative_url }}" alt="Kai Dong" loading="lazy"><div><h3>Kai Dong</h3><p>Bachelor's graduate (2018.09-2022.06)<br>Ph.D. student, Peking University</p></div></article>
</div>
